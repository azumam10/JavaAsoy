package project.RentalPs;

import java.sql.*;//Ini untuk mengimpor komponen-komponen GUI Swing
import javax.swing.*;//untuk menampilkan data dari database dalam format tabel
...
public class RentalPlayStation extends JFrame {
    ...
    public RentalPlayStation() {
        ...
        try {
            conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/rental_ps", "root", "");
        ...
        lblLamaSewa.setBounds(20, 140, 125, 25);
        add(lblLamaSewa);
